...
ROOT_URLCONF = 'mining_fraudsters_and_fraudulent.urls'
...
WSGI_APPLICATION = 'mining_fraudsters_and_fraudulent.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mining_fraudsters_and_fraudulent',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
